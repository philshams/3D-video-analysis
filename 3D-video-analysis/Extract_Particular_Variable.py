...
'speed', 'velocity relative to shelter', 'head direction relative to shelter', 'head turn relative to shelter', 'distance from shelter', 'in shelter', 'position', 'behavioural cluster'
'''
...
variables_of_interest = ['speed', 'velocity relative to shelter', 'head direction relative to shelter', 
                         'head turn relative to shelter', 'distance from center', 'in shelter', 'position', 'behavioural cluster']
