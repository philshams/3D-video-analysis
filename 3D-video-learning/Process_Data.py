...
#                    print(orientation_angles_flipped[flip_counter])
#                    print(orientation_angles_cur[frame_of_preprocessed_data])
#                    
...
#                        -1 * velocity_cur[frame_of_preprocessed_data, 2] + -1 * velocity_cur[frame_of_preprocessed_data, 3] * 1j, deg=True)
                ...
                if realign:
                    ...
                    print(ellipse_width > width_threshold)
