...
#%% ----------------------------------------------------------------------------------------------------------------------------------
def calculate_and_save_model_output(data, model, num_clusters, file_loc, model_type, suffix, twoD_suffix, do_not_overwrite):
    ...
    np.save(file_loc + '_data_for_' + model_type + '_normalized' + twoD_suffix, data_for_model_normalized)
