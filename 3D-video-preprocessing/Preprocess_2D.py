...
# ------------------------------------------
video_file_location = "C:\\Drive\\Video Analysis\\data\\baseline_analysis\\17.03.2018\\215_1a\\"
video_name = "Chronic_Mantis_stim_background_clicks-default-455231-video-"
videos = [0]

save_folder_location = "C:\\Drive\\Video Analysis\\data\\baseline_analysis\\test_pipeline\\"
session_name_tag = "clicks_3"  # name-tag to be associated with all saved files
initial_run = True
...
#         **** this section is specific to the Branco Lab Barns Maze -- modify for other arenas ******
            ...
            if np.sqrt((y_center - arena_center[1]) ** 2 + (x_center - arena_center[0]) ** 2) > arena_radius and \
                    np.sqrt((y_center - y_center_prev) ** 2 + (x_center - x_center_prev) ** 2) > (speed_thresh * 3):
