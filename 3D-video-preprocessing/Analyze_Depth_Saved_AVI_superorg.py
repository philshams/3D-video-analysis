...
write_images = False #must update for super-organism
...
while True:
    ...
    if ret:  
        ...
        double_mouse_thresh = 7000 #biggest contour must be under this size -- 7000
        ...
        for mouse in [0,1]:
            ...
            if write_images and togetherR:
                ...
                if write_cropped_mice:
                    ...
                    cropped_mouse.write(frame_R_resized)
...
if save_data:
    data_video.release()
    if os.path.isfile(file_loc + '_frames') and not do_not_overwrite:
        ...
        np.save(file_loc + 'start_end_frame', [start_frame, frame_num])
