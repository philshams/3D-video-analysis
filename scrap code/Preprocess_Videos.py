...
# ----------------------------
mask_thresh = .39 #mouse mask threshold (lower is more stringently darker than background)
kernel = [4,3] #erosion and dilation kernel sizes for mouse mask
iters = [1,6] #number of erosion and dilation iterations for mouse mask
