...
feature_relevance_threshold = 0.001; modify_relevant_features_from_previous_runs = False
downsample_every_other = 2 #if too much data to store in memory, downsample
num_LDCs = 2; flip_threshold = .99
...
if sum(wavelet_feature_stds==0) > 0:
    raise Exception('invalid relevant features')
...
# --------------------------------------------
# Generate the LDCs from the wavelet features
# --------------------------------------------
